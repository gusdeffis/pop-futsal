...
export function CheckAzul({ label, checked, onChange, minHeight, padding = '12px 10px', sinMayuscula, color = C.azul, colorInactivo = C.celeste }) {
  ...
  return (
    <div onClick={() => onChange(!checked)} style={{
      ...
      <span style={{ fontSize: 13, color: checked ? '#fff' : color, lineHeight: 1.2, fontWeight: 600, textTransform: sinMayuscula ? 'none' : 'uppercase', minWidth: 0, wordBreak: 'break-word' }}>
