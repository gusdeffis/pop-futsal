      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button onClick={handleGenerarPDF} disabled={generandoPDF}
            style={{ flex: 1, height: 50, background: generandoPDF ? '#8fa3c9' : '#ffe066', color: '#000', border: 'none', borderRadius: 8, fontSize: 15, fontWeight: 700, cursor: generandoPDF ? 'wait' : 'pointer' }}>
