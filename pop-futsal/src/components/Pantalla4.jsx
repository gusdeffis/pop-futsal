  ...
  return (
    <div style={{ maxWidth: 480, margin: '0 auto', background: '#fff', minHeight: '100vh', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ background: BORDO, color: '#fff', fontWeight: 700, fontSize: 12, padding: '8px 12px', borderRadius: 6, textAlign: 'center', textTransform: 'uppercase', letterSpacing: .5 }}>
          Marcar si hay incumplimiento o problema
        </div>

        {/* Mesa cronometraje */}
        <div style={{ fontSize: 11, fontWeight: 700, color: BORDO, letterSpacing: .5, textTransform: 'uppercase' }}>
        ...
        <div style={{ background: ROSA, border: `1.5px solid ${BORDO}`, borderRadius: 8, padding: 10 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: BORDO, marginBottom: 8, textTransform: 'uppercase' }}>Público</div>
          <div style={{ display: 'flex', gap: 6 }}>
            <LVRojo label="L" checked={datos.publico_l} onChange={set('publico_l')} />
            <LVRojo label="V" checked={datos.publico_v} onChange={set('publico_v')} />
          </div>
        </div>
