...
const FILAS_INSTALACIONES = [
  { cols: 3, items: [
    ['buen_estado', 'Campo en Buen estado', { sinMayuscula: true, lineas: ['Campo en', 'Buen estado'] }],
  ...
  { cols: 3, items: [
    ...
    ['pared_prot', 'Pared Con Proteccion', { sinMayuscula: true, lineas: ['Pared Con', 'Proteccion'] }],
    ['redes_per', 'Redes Perimetral.', { sinMayuscula: true, lineas: ['Redes', 'Perimetral.'] }],
  ] },
  ...
  { cols: 3, items: [
    ...
    ['vest_arb', 'Vestuario Arbitros', { sinMayuscula: true, lineas: ['Vestuario', 'Arbitros'] }],
  ] },
  { cols: 3, items: [
      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
          ...
          <CheckAzul
            ...
            minHeight={ALTO_BOTON_INSTALACIONES} padding={PADDING_BOTON_INSTALACIONES}
            color="#e03030" colorInactivo="#e0e0e0"
          />
        </div>
