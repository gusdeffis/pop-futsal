  ...
  return (
    <div>
      ...
      >
        ...
        {foto && !enviada && (
          <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: '#1a7a3a' }}>
            ✓ LISTA
          </div>
        )}
        {enviada && (
          <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: '#1a7a3a' }}>
            ✓ ENVIADA
          </div>
        )}
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
        ...
        <button
          ...
          style={{
            ...
            fontSize: 11, fontWeight: 600, textAlign: 'center', lineHeight: 1.1, padding: '0 4px',
            cursor: !listasParaEnviar ? 'default' : (enviando ? 'wait' : 'pointer'),
          }}
        >
          {enviando ? 'Enviando...' : 'Enviar x WSP'}
        </button>
      </div>
