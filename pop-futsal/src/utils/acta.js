import { textoHorariosCompleto, capitalizarFrase } from './desviosHorarios';
...
export function generarActaTexto(datos, opciones = {}) {
  ...
  if (datos.comenzo_si === 'no' && datos.motivo_inicio) {
    partes.push(`El partido no comenzó en horario. Motivo: ${capitalizarFrase(datos.motivo_inicio)}.`);
  }
